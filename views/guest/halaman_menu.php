<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <div class="row">
        <div class="col-md-8">
            <br> <br> <br>
        <h1 class="display-4 text-white bayangan">WELCOME TO E-TICKET</h1>
            <h5 class="text-white bayangan">Melayani Pemesanan Tiket Kereta Api Secara Cepat Dan Mudah.</h5>
        </div>
    ...
    <script src="<?=base_url('assets/js/bootstrap.min.js') ?>"></script>
        ...
        <div class="col-md-4">
            <form action="<?= base_url('tiket') ?>" method="POST">
                <div class="form-group">
                    <label class="text-white bayangan font-weight-bold">Stasiun Awal</label>
        ...
        <div class="form-group">
                    <label class="text-white bayangan font-weight-bold">Tanggal Keberangkatan</label>
